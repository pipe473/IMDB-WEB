...
class Movie {
  ...
  constructor(picture, title, releaseYear, nacionality, genre) {
    ...
    this.eyeColor = "";
    this.race = "";
    this.isRetired = Boolean;
    this.oscasrsNumber = Number;
    this.nationality = "";
    this.profession = "";
  }
}
...
let actor1Movie1 = new Professional(
  "./img/P1 - lo que el viento se llevó/Clark_Gable_-_publicity.jpg",
  "Clark Gable",
  59,
  "Masculino",
  80,
...
let actor2Movie1 = new Professional(
  "./img/P1 - lo que el viento se llevó/Vivien_Leigh_Scarlet.jpg",
  "Vivien Leigh",
  53,
  "Femenino",
  55,
...
let actor3Movie1 = new Professional(
  "./img/P1 - lo que el viento se llevó/Leslie_Howard_GWTW.jpg",
  "Leslie Howard",
  50,
  "Masculino",
  73,
...
let actor4Movie1 = new Professional(
  "./img/P1 - lo que el viento se llevó/220px-Olivia_de_Havilland_1936.jpg",
  "Olivia de Havilland",
  104,
  "Femenino",
  57,
...
let movie1 = new Movie(
  "./img/P1 - lo que el viento se llevó/viento-se-llevo.jpg",
...
let movie2 = new Movie(
  "./img/P2- padre no hay mas que uno 2/padre-no-hay-mas-que-uno.jpg",
...
let actor1Movie3 = new Professional(
  "./img/P3-Forrest gump/Tom_Hanks_face.jpg",
  "Tom Hanks",
  64,
  "Masculino",
  86,
...
let actor2Movie3 = new Professional(
  "/img/P3-Forrest gump/Robin_Wright_Cannes_2017.jpg",
  "Robin Wright",
  54,
  "Femenino",
  59,
...
let actor3Movie3 = new Professional(
  "/img/P3-Forrest gump/Gary_Sinise_2011_(cropped).jpg",
  "Gary Sinise",
  65,
  "Masculino",
  70,
...
let movie3 = new Movie(
  "/img/P3-Forrest gump/forrest-gump.jpg",
  "Forrest Gump",
  1994,
  "Estados Unidos",
...
let actor1Movie4 = new Professional(
  "./img/P4-Frozen/220px-Kristen_Bell_Frozen_premiere_2013_(cropped).jpg",
  "Kristen Bell",
  40,
  "Femenino",
  50,
...
let actor2Movie4 = new Professional(
  "./img/P4-Frozen/Idina_Menzel_Defense.gov_Crop.png",
  "Indina Menzel",
  49,
  "Femenino",
  52,
...
let actor3Movie4 = new Professional(
  "./img/P4-Frozen/Jonathan_Groff_at_Outfest_2013.jpg",
  "Jonathan Groff",
  35,
  "Masculino",
  77,
...
let actor4Movie4 = new Professional(
  "./img/P4-Frozen/josh_gad_1011.jpg",
  "Josh Gad",
  39,
  "Masculino",
  72,
...
//Película 5:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie5 = new Professional(
  "./img/P5 - The Gentlemen/Matthew_McConaughey_2011.jpg",
  "Matthew McConaughey",
  64,
  "Masculino",
  80,
...
let actor2Movie5 = new Professional(
  "./img/P5 - The Gentlemen/Charlie_Hunnam_at_Berlinale_2017.jpeg",
  "Charlie Hunnam",
  55,
  "Masculino",
  59,
...
let actor3Movie5 = new Professional(
  "/img/P5 - The Gentlemen/colin farrel.jpg",
  "Colin Farrell",
  45,
  "Masculino",
  76,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos como atributos de nuestro objeto Movie.
let directorMovie5 = new Professional(
  "Guy Ritchie",
  66,
  "Masculino",
  90,
...
let escritorMovie5 = new Professional(
  "Ivan Atkinson",
  60,
  "Masculino",
  70,
...
let movie5 = new Movie(
  "./img/P5 - The Gentlemen/the_gentlemen-425828685-large.jpg",
...
//Película 6:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie6 = new Professional(
  "./img/P6 - The Peanut Butter Falcon/zak gottsagen.jpg",
  "Zack Gottsagen",
  38,
  "Masculino",
  86,
...
let actor2Movie6 = new Professional(
  "./img//P6 - The Peanut Butter Falcon/Shia_LaBeouf_2019.jpg",
  "Shia LaBeouf",
  29,
  "Femenino",
  55,
...
let actor3Movie6 = new Professional(
  "/img//P6 - The Peanut Butter Falcon/dakota_0381a0b9_900x1352.jpg",
  "Dakota Johnson",
  33,
  "Femenino",
  60,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos como atributos de nuestro objeto Movie.
let directorMovie6 = new Professional(
  "Tyler Nilson",
  69,
  "Masculino",
  74,
...
let escritorMovie6 = new Professional(
  "Mike Schwartz",
  75,
  "Masculino",
  78,
...
let movie6 = new Movie(
  "./img/P6 - The Peanut Butter Falcon/the_peanut_butter_falcon-642324654-large.jpg",
...
//Película 7:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie7 = new Professional(
  "./img/P7 - Invisibles/emma suarez.jpg",
  "Emma Suárez",
  54,
  "Femenino",
  69,
...
let actor2Movie7 = new Professional(
  "./img/P7 - Invisibles/Adriana_ozores5.jpg",
  "Adriana Ozores",
  52,
  "Femenino",
  59,
...
let actor3Movie7 = new Professional(
  "./img/P7 - Invisibles/Gary_Sinise.jpg",
  "Gary Sinise",
  65,
  "Masculino",
  70,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos como atributos de nuestro objeto Movie.
let directorMovie7 = new Professional(
  "Santos Mercero",
  65,
  "Masculino",
  78,
...
let escritorMovie7 = new Professional(
  "Gracia Querejeta",
  58,
  "Masculino",
  70,
...
let movie7 = new Movie(
  "./img/P7 - Invisibles/invisibles-949856399-large.jpg",
  "Invisibles",
  2020,
  "España",
  "Drama | Amistad"
...
//Película 8:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie8 = new Professional(
  "./img/P8 - Harry Potter/daniel.jpg",
  "Daniel Radcliffe",
  31,
  "Masculino",
  80,
...
let actor2Movie8 = new Professional(
  "./img/P8 - Harry Potter/MV5BMjI3MDA3NjA1N15BMl5BanBnXkFtZTcwMDcyMDYzNw@@._V1_.jpg",
  "Rupert Grint",
  30,
  "Masculino",
  73,
...
let actor3Movie8 = new Professional(
  "./img/P8 - Harry Potter/emma.jpg",
  "Emma Watson",
  30,
  "Femenino",
  55,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos también como atributos de nuestro objeto Movie.
let escritorMovie8 = new Professional(
  "Steve Kloves",
  56,
  "Masculino",
  76,
...
let directorMovie8 = new Professional(
  "Chris Columbus",
  63,
  "Masculino",
  78,
...
let movie8 = new Movie(
  "./img/P8 - Harry Potter/harry-potter.jpg",
...
//Película 9:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie9 = new Professional(
  "./img/P9 - el regereso de Mary Poppins/Emily_Blunt.jpg",
  "Emily Blunt",
  31,
  "Femenino",
  50,
...
let actor2Movie9 = new Professional(
  "./img/P9 - el regereso de Mary Poppins/Ben_Whishaw.jpg",
  "Ben Whishaw",
  40,
  "Masculino",
  78,
...
let actor3Movie9 = new Professional(
  "./img/P9 - el regereso de Mary Poppins/MV5BMTM2NjIzMDg3NV5BMl5BanBnXkFtZTcwNDQ5MzczNA@@._V1_.jpg",
  "Emily Mortimer",
  24,
  "Femenino",
  65,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos también como atributos de nuestro objeto Movie.
let escritorMovie9 = new Professional(
  "David Magee",
  39,
  "Masculino",
  76,
...
let directorMovie9 = new Professional(
  "Rob Marshall",
  58,
  "Masculino",
  78,
...
let movie9 = new Movie(
  "./img/P9 - el regereso de Mary Poppins/mary-poppins.jpg",
...
//Película 10:
//Creamos objetos de clase Professional para añadirlos más tarde en el atributo actors al objeto Movie.
let actor1Movie10 = new Professional(
  "Gal Gadot",
  31,
  "Femenino",
  66,
...
let actor2Movie10 = new Professional(
  "Chris Pine",
  40,
  "Masculino",
  70,
...
let actor3Movie10 = new Professional(
  "David Thewlis",
  24,
  "Masculino",
  65,
...
// Creamos los objetos de la clase Professional Director (con atributo profesión director) y Escritor (con atributo profesión guionista) para incluirlos también como atributos de nuestro objeto Movie.
let escritorMovie10 = new Professional(
  "Allan Heinberg",
  39,
  "Masculino",
  76,
...
let directorMovie10 = new Professional(
  "Patty Jenkins",
  58,
  "Femenino",
  50,
...
let movie10 = new Movie(
  "./img/P10- Wonder Woman/wonder-woman.jpg",
  "Wonder Woman",
  2017,
  "Estados Unidos",
  "Fantástico. Acción. Bélico. Aventuras | Superhéroes. Cómic. DC Comics. I Guerra Mundial"
);
